...
namespace ECAN
{
    ...
    //    CAN_OBJ[] ca = new CAN_OBJ[] { CAN_OBJ.InitByteArray() };
    ...
    */
    ...
    public static class ECANDLL
    {
        ...
        public static extern ECANStatus ReadBoardInfo(
         ...
         public static extern UInt32 SetReference(UInt32 DeviceType, UInt32 DeviceInd, UInt32 CANInd, UInt32 RefType, UInt32 pData);
